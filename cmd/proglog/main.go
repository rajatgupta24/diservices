...
import (
	...
	"github.com/rajatgupta24/diservices/internal/agent"
	"github.com/rajatgupta24/diservices/internal/config"
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().StringSlice("start-join-addr",
		nil,
...
func (c *cli) setupConfig(cmd *cobra.Command, args []string) error {
	...
	c.cfg.ACLModeFile = viper.GetString("acl-mode-file")
